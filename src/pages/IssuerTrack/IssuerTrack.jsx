  ...
  return (
    <div className="bg-white p-16">
      <h2 className="text-2xl text-center font-bold my-3">
        Your tracking ID: <span className="text-blue-500">{trackingId}</span>
      </h2>
      <p className="text-2xl text-center font-bold my-3">
        Log so far: <span className="text-blue-500">{trackings.length}</span>
      </p>
        ...
        {trackings.map((log) => (
          <li key={log._id}>
            ...
            <div className="timeline-end timeline-box">
              <span className="text-blue-500 font-bold">{log.message}</span>
            </div>
            <hr />
          </li>
        ))}
